...
Struct[{
  ...
  'RxCoalesceSec'                       => Optional[Systemd::Timespan],
  'RxCoalesceIrqSec'                    => Optional[Systemd::Timespan],
  'RxCoalesceLowSec'                    => Optional[Systemd::Timespan],
  'RxCoalesceHighSec'                   => Optional[Systemd::Timespan],
  'TxCoalesceSec'                       => Optional[Systemd::Timespan],
  'TxCoalesceIrqSec'                    => Optional[Systemd::Timespan],
  'TxCoalesceLowSec'                    => Optional[Systemd::Timespan],
  'TxCoalesceHighSec'                   => Optional[Systemd::Timespan],
  ...
  'CoalescePacketRateSampleIntervalSec' => Optional[Systemd::Timespan],
  'StatisticsBlockCoalesceSec'          => Optional[Systemd::Timespan],
...
Struct[{
  ...
  'OriginatorIntervalSec' => Optional[Systemd::Timespan],
...
Struct[{
  ...
  'MIIMonitorSec'                => Optional[Variant[Systemd::Timespan,Numeric]],
  'PeerNotifyDelaySec'           => Optional[Systemd::Timespan],
  'UpDelaySec'                   => Optional[Systemd::Timespan],
  'DownDelaySec'                 => Optional[Systemd::Timespan],
  'LearnPacketIntervalSec'       => Optional[Systemd::Timespan],
  ...
  'ARPIntervalSec'               => Optional[Systemd::Timespan],
  'ARPIPTargets'                 => Optional[String[1]],
  'ARPAllTargets'                => Optional[Enum['any','all']],
  'PrimaryReselectPolicy'        => Optional[Enum['always', 'better', 'failure']],
...
Struct[{
  ...
  'FDBAgeingSec'             => Optional[Systemd::Timespan],
...
Struct[{
  ...
  'DefaultLeaseTimeSec'  => Optional[Systemd::Timespan],
  'MaxLeaseTimeSec'      => Optional[Systemd::Timespan],
  'UplinkInterface'      => Optional[String[1]],
  ...
  'IPv6OnlyPreferredSec' => Optional[Systemd::Timespan],
...
Struct[{
  ...
  'Prefix'                   => Optional[String[1]],
  'PreferredLifetimeSec'     => Optional[Systemd::Timespan],
  'ValidLifetimeSec'         => Optional[Systemd::Timespan],
  'Assign'                   => Optional[Enum['yes','no']],
  'Token'                    => Optional[String[1]],
  'RouteMetric'              => Optional[Integer[0, 4294967295]],
}]
...
Struct[{
  ...
  'IPv6RetransmissionTimeSec'          => Optional[Systemd::Timespan],
...
Struct[{
  'Parent'         => Optional[Variant[Enum['root', 'clsact','ingress'],String[1]]],
  'Handle'         => Optional[String[1]],
  'DelayJitterSec' => Optional[Systemd::Timespan],
  'PacketLimit'    => Optional[Integer[0,4294967294]],
...
Struct[{
    'Parent'           => Optional[Variant[Enum['root', 'clsact', 'ingress'], String[1]]],
    'Handle'           => Optional[String[1]],
    'PerturbPeriodSec' => Optional[Systemd::Timespan],
  }]
```
...
Struct[{
    ...
    Optional['RateLimitInterval']    => Variant[Systemd::Timespan,Systemd::JournaldSettings::Ensure],
    Optional['RateLimitIntervalSec'] => Variant[Systemd::Timespan,Systemd::JournaldSettings::Ensure],
    ...
    Optional['MaxFileSec']           => Variant[Systemd::Timespan,Systemd::JournaldSettings::Ensure],
    Optional['MaxRetentionSec']      => Variant[Systemd::Timespan,Systemd::JournaldSettings::Ensure],
    Optional['SyncIntervalSec']      => Variant[Systemd::Timespan,Systemd::JournaldSettings::Ensure],
...
Struct[{
    ...
    Optional['HoldoffTimeoutSec']            => Variant[Systemd::Timespan,Systemd::LogindSettings::Ensure],
    ...
    Optional['IdleActionSec']                => Variant[Systemd::Timespan,Systemd::LogindSettings::Ensure],
    Optional['InhibitDelayMaxSec']           => Variant[Systemd::Timespan,Systemd::LogindSettings::Ensure],
...
Alias of `Variant[Enum['infinity', ''], Integer[0], Pattern[/^([0-9]+ *(usec|us|msec|ms|seconds?|sec|s|minutes?|min|m|hours?|hr|h|days?|d|weeks?|w|months?|M|years?|y)? *)+$/]]`
...
Struct[{
    ...
    Optional['TimeoutAbortSec']           => Systemd::Timespan,
    Optional['TimeoutSec']                => Systemd::Timespan,
    Optional['TimeoutStartFailureMode']   => Enum['terminate', 'abort', 'kill'],
    Optional['TimeoutStopFailureMode']    => Enum['terminate', 'abort', 'kill'],
    Optional['RuntimeMaxSec']             => Systemd::Timespan,
    Optional['RuntimeRandomizedExtraSec'] => Systemd::Timespan,
    Optional['WatchdogSec']               => Systemd::Timespan,
    Optional['Restart']                   => Enum['no', 'on-success', 'on-failure', 'on-abnormal', 'on-watchdog', 'on-abort', 'always'],
    Optional['RestartMaxDelaySec']        => Systemd::Timespan,
    ...
    Optional['TemporaryFileSystem']       => Variant[String[0],Array[String[0],1]],
    ...
    Optional['KeyringMode']               => Enum['inherit', 'private', 'shared'],
    Optional['CapabilityBoundingSet']     => Variant[String, Array[String]],
    Optional['AmbientCapabilities']       => Variant[Enum[''], Pattern[/^CAP_[A-Z_]+$/],Array[Variant[Enum[''], Pattern[/^CAP_[A-Z_]+$/]],1]],
    ...
    Optional['LogRateLimitIntervalSec']   => Systemd::Timespan,
...
Struct[{
    ...
    Optional['StartLimitIntervalSec']       => Systemd::Timespan,
    ...
    Optional['JobTimeoutSec']               => Systemd::Timespan,
    Optional['JobRunningTimeoutSec']        => Systemd::Timespan,
